...
import { 
  faLaptopCode, faMobileAlt, faPaintBrush, faSearch, 
  faBullhorn, faChartLine, faArrowRight, faEnvelope, 
  faMapMarkerAlt, faPhoneAlt, faChevronLeft, faChevronRight, 
